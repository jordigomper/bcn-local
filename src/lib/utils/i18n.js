export const I18n = {
  ...
  init() {
    ...
    if (savedLang && this.translations[savedLang]) {
      ...
      if (browserLang.startsWith('ca')) this.currentLanguage = 'ca'
      else if (browserLang.startsWith('en')) this.currentLanguage = 'en'
      else this.currentLanguage = 'es'
    }
    this.updateUI()
  },
  updateUI() {
    if (typeof window.updateTranslations === 'function') window.updateTranslations()
  }
}
